...
class ChromadbVectorStore(VectorStore):
    def __init__(self, config=None):
        ...
        elif isinstance(curr_client, chromadb.api.async_api.AsyncClientAPI):
    ...
    @classmethod
    async def create_async(cls, config=None) -> "ChromadbVectorStore":
        """
        异步创建 ChromadbVectorStore 实例

        Args:
            config: 配置字典

        Returns:
            ChromadbVectorStore: 初始化的实例
        """
